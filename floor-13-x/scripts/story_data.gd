...
const AREAS := [
	{
		...
		"hotspots": [
			...
			["drawer", "LOCKED DRAWER", [198, 119, 75, 42], [
				...
				## [fork] The rule the whole night runs on, planted here in File 1 so it is the
				## player's idea before it is anybody's line.
				["MARA / CARBON NOTE", "They do not start with the name. The name is expensive and somebody notices. They start with the record of having been touched — a hand on a wrist, a coat somebody helped you into — because it is the cheapest line on the sheet and the hardest one to prove was ever there."],
				["JUNE", "June Park, twenty-nine, temporary. I signed nothing that said they could take an inventory of who has held my arm. Then again, I signed a flexible close, and apparently that was the same document."]
			]]
		],
		"transition": [
	...
	},
	{
		...
		"transition": [
			...
			## [fork] The quarter inch. Shown, not explained — the explanation is the `coat`
			## hotspot in File 3, and only if the player goes looking for it.
			["NARRATION", "The red line reaches the end of the row. Eli moves to take June's sleeve and steer her out of it, and his hand closes on the air a quarter of an inch outside the fabric, and neither of them moves for a second afterwards."],
			["JUNE", "You missed."],
			["ELI", "I did not miss. Walk. I will explain it somewhere the phone cannot hear, and you are going to want to be sitting down, and you are going to want to not have said the word ghost first."],
			["NARRATION", "June looks at her own sleeve on the way to the break room. It is undisturbed in a way that a sleeve somebody has just reached for should not be, and the office behind her marks forty empty chairs PRESENT."]
		]
	},
	{
		...
		"opening": [
			## [fork] The base line gave Eli an age in the low twenties. ops/adult_forks/floor-13.md §2 makes
			## rewriting it non-negotiable: Eli Song is 31, and every character in this fork reads
			## unambiguously as an adult. Changed in all five locale files.
			["NARRATION", "Eli leads June into the break room, where the refrigerator motor masks their voices. Under green emergency light he looks every one of his thirty-one years and exhausted enough to be ancient."],
			["ELI", "Thirty-one. Six of those weeks have been the same Monday, so by lived hours I am the most senior person in this building, and I have been paid for none of them."],
