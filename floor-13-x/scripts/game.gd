...
func _show_hotspots(optional_only := false) -> void:
	...
	for hotspot in area.hotspots:
		...
		hover.bg_color = Color("#6a360d33")
		hover.border_color = Color("#f7b54e")
		hover.set_border_width_all(1)
		var pressed := normal.duplicate()
		pressed.bg_color = Color("#69123555")
		pressed.border_color = Color("#f71e72")
		...
		marker.add_theme_color_override("font_color", Color("#f7cf96"))
		marker.add_theme_color_override("font_outline_color", Color("#160903"))
