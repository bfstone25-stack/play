/* floor13x_gate.js — the CG gate for Floor 13: Retention's two *web* tracks.
 *
 ...
 *
 * Contract with scripts/cg_gate.gd:
 *   window.Floor13xGate.require(key, {title, kind}) -> Promise<"unlocked"|"unavailable"|"closed">
 */
(function () {
  if (window.Floor13xGate) return;
  ...
  window.Floor13xGate = {require: requireCg, creativeShown: creativeShown};
})();
