...
const EN := {
	...
	"title.slice": "FREE BROWSER SLICE — CHAPTERS I–II",
...
const ZH := {
	...
	"title.slice": "免费试玩章节 — 第一至二章",
	"slice.end": "免费试玩 — 验房暂停",
	"slice.beat.0": "玛拉：清单是真的。房子不是空的。墙里有东西在回应。",
	"slice.beat.1": "完整验房还将继续：厨房里的污渍、会敲三下的水管、卧室的衣柜、过夜条款——以及02:29的最后敲门声。",
	"slice.beat.2": "共七章。三个结局。你的选择决定艾里斯·维尔会被见证、被顶替，还是被抹去。",
	"slice.thanks": "404室 — 免费试玩\n\n完整验房请见下方正式版。\n\n按 R 再走一遍走廊。",
...
const JA := {
	...
	"title.slice": "無料スライス — 第I–II章",
	"slice.end": "無料スライス — 検査中断",
	"slice.beat.0": "マラ：チェックリストは本物だ。部屋は空きじゃない。壁の中から何かが応える。",
	"slice.beat.1": "完全版の検査は続く：キッチンの染み、三度ノックする配管、寝室のワードローブ、宿泊条項——そして02:29の最後のノック。",
	"slice.beat.2": "全七章。三つの結末。アイリス・ヴェイルが目撃されるか、置き換えられるか、消されるかは、あなたの選択次第だ。",
	"slice.thanks": "404号室 — 無料スライス\n\n完全版の検査は下の製品版へ。\n\nRでもう一度廊下へ。",
...
const ES := {
	...
	"title.slice": "PRUEBA GRATUITA — CAPÍTULOS I–II",
	"slice.end": "PRUEBA GRATUITA — INSPECCIÓN SUSPENDIDA",
	"slice.beat.0": "MARA: La lista es real. El piso no está vacío. Algo responde desde dentro de las paredes.",
	"slice.beat.1": "La inspección completa continúa: la mancha de la cocina, la tubería que golpea tres veces, el armario del dormitorio, la cláusula nocturna… y el último golpe a las 02:29.",
	"slice.beat.2": "Siete capítulos. Tres finales. Tus decisiones deciden si Iris Vale es presenciada, reemplazada o borrada.",
	"slice.thanks": "PISO 404 — PRUEBA GRATUITA\n\nLa inspección completa espera en la edición completa.\n\nPulsa R para recorrer el pasillo otra vez.",
...
const KO := {
	...
	"title.slice": "무료 체험 — 1–2장",
	"slice.end": "무료 체험 — 점검 중단",
	"slice.beat.0": "마라: 체크리스트는 진짜다. 집은 비어 있지 않다. 벽 안에서 무언가가 대답한다.",
	"slice.beat.1": "전체 점검은 계속된다: 주방의 얼룩, 세 번 노크하는 배관, 침실 옷장, 숙박 조항——그리고 02:29의 마지막 노크.",
	"slice.beat.2": "일곱 개의 장. 세 개의 결말. 아이리스 베일이 목격될지, 대체될지, 지워질지는 당신의 선택에 달렸다.",
	"slice.thanks": "404호 — 무료 체험\n\n전체 점검은 아래 정식판에서.\n\nR을 눌러 복도를 다시 걷는다.",
