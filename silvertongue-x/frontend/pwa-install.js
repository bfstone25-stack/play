(() => {
  ...
  const copy = (lang.startsWith("zh-hant") || lang.startsWith("zh-tw") || lang.startsWith("zh-hk") || lang === "zht") ? {
    pitch:"喜歡這個產品？", install:"安裝應用", close:"稍後",
    updatePitch:"新版本已經準備好", update:"立即更新", refresh:"重新整理進入新版",
    installing:"正在安裝…", installed:"已安裝。如果主畫面沒有圖示，請從底部上滑打開「所有應用」，找到它後長按並拖到主畫面。",
    ios:"在 Safari 中點「分享」，然後選擇「加入主畫面」。",
    mac:"在 Safari 選單列選擇「檔案 → 加入 Dock」。若沒有這個選項，需要 macOS Sonoma 14 或更新版本。", got:"知道了"
  } : lang.startsWith("zh") ? {
