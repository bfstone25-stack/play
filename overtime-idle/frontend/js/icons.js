const ICONS = (() => {
  ...
  const draw = {
    ...
    // ---- gacha staff (overtime-idle) ----
    nia(ctx, s) {          // the auditor: a ledger with a red line through it
      fill(ctx, () => { ctx.roundRect(-s * 0.24, -s * 0.3, s * 0.48, s * 0.6, 3); }, C.ink);
      stroke(ctx, () => {
        ctx.moveTo(-s * 0.14, -s * 0.16); ctx.lineTo(s * 0.14, -s * 0.16);
        ctx.moveTo(-s * 0.14, -s * 0.04); ctx.lineTo(s * 0.14, -s * 0.04);
        ctx.moveTo(-s * 0.14, s * 0.08); ctx.lineTo(s * 0.14, s * 0.08);
      }, C.steel, s * 0.045);
      stroke(ctx, () => { ctx.moveTo(-s * 0.2, s * 0.2); ctx.lineTo(s * 0.2, -s * 0.22); }, "#c45c32", s * 0.06);
    },
    sol(ctx, s) {          // the night editor: a desk lamp that is still on
      stroke(ctx, () => { ctx.moveTo(-s * 0.1, s * 0.28); ctx.lineTo(s * 0.12, -s * 0.1); }, C.steel, s * 0.06);
      fill(ctx, () => { ctx.roundRect(-s * 0.26, s * 0.24, s * 0.36, s * 0.08, 2); }, C.steel);
      fill(ctx, () => { ctx.moveTo(s * 0.02, -s * 0.14); ctx.lineTo(s * 0.3, -s * 0.26); ctx.lineTo(s * 0.3, -s * 0.02); ctx.closePath(); }, C.amber);
      fill(ctx, () => { ctx.moveTo(s * 0.3, -s * 0.02); ctx.lineTo(s * 0.02, -s * 0.14); ctx.lineTo(s * 0.34, s * 0.3); ctx.lineTo(s * 0.5, s * 0.3); ctx.closePath(); }, "rgba(224,161,74,0.28)");
    },
  };
