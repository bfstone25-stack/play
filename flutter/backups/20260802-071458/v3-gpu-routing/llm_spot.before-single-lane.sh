...
LANES=(logos mingxi shifu flutter-west flutter-zh flutter-ja tell appealpro medikin games spec)
unit_for(){ case "$1" in logos) echo llamacpp-logos;; mingxi) echo llamacpp-mingxi;; shifu) echo llamacpp-shifu;; flutter-west) echo llamacpp-flutter-west-v3;; flutter-zh) echo llamacpp-flutter-zh-v3;; flutter-ja) echo llamacpp-flutter-ja-v3;; tell) echo llamacpp-tell;; appealpro) echo llamacpp-appealpro;; medikin) echo llamacpp-medikin;; games) echo llamacpp-gemma;; spec) echo llamacpp-spec;; esac; }
cost_for(){ case "$1" in logos|mingxi|shifu|games) echo 7000;; flutter-west|flutter-zh|flutter-ja|appealpro|medikin) echo 5100;; tell) echo 4600;; spec) echo 10500;; esac; }
...
flutter-west:GPU) echo "$VK -m $LLAMA --lora %h/Projects/apps/flutter/models/psyche-v3/west/flutter-west-psyche-v3-f16.gguf -c 4096 -ngl 99 --device Vulkan1 -t 2 --host 127.0.0.1 --port 8851";; flutter-west:CPU) echo "$CPU -m $LLAMA --lora %h/Projects/apps/flutter/models/psyche-v3/west/flutter-west-psyche-v3-f16.gguf -c 4096 -t 10 --host 127.0.0.1 --port 8851";;
flutter-zh:GPU) echo "$VK -m $QWEN --lora %h/Projects/apps/flutter/models/psyche-v3/zh/flutter-zh-psyche-v3-f16.gguf -c 4096 -ngl 99 --device Vulkan1 -t 2 --host 127.0.0.1 --port 8852";; flutter-zh:CPU) echo "$CPU -m $QWEN --lora %h/Projects/apps/flutter/models/psyche-v3/zh/flutter-zh-psyche-v3-f16.gguf -c 4096 -t 10 --host 127.0.0.1 --port 8852";;
flutter-ja:GPU) echo "$VK -m $QWEN --lora %h/Projects/apps/flutter/models/psyche-v3/ja/flutter-ja-psyche-v3-f16.gguf -c 4096 -ngl 99 --device Vulkan1 -t 2 --host 127.0.0.1 --port 8853";; flutter-ja:CPU) echo "$CPU -m $QWEN --lora %h/Projects/apps/flutter/models/psyche-v3/ja/flutter-ja-psyche-v3-f16.gguf -c 4096 -t 10 --host 127.0.0.1 --port 8853";;
