...
# 分段生成: 每段90帧@24fps=3.75秒. 参数: 段名 prompt
SEG=sys.argv[1]; PROMPT=sys.argv[2]
FRAMES=90; FI_ITER=2
...
W={
 ...
 '13':{'class_type':'VHS_VideoCombine','inputs':{'images':['12',0],'frame_rate':24,'loop_count':0,'filename_prefix':f'seg_{SEG}','format':'video/h264-mp4','pingpong':False,'save_output':True}},
}
