...
FRAMES=48; FI_ITER=1
# 黑白线稿风格(高端不俗)
STYLE='black and white line art, clean ink linework, minimalist monochrome, hand-drawn animation, no color, white background, elegant'
NEG='color, colorful, painting, realistic, photo, 3d, grey shading, ugly, blurry, deformed, mutated, inflating body, text, watermark, multiple characters'
BODY='a cute goofy capsule mascot character, big goggle eyes, buck-tooth grin, round belly, thin legs'
FULL = f'"0": "{BODY}, {ACTION}, {STYLE}"'
W={
 ...
 '7':{'class_type':'IPAdapterAdvanced','inputs':{'model':['2',0],'ipadapter':['4',0],'image':['6',0],'clip_vision':['5',0],'weight':0.6,'weight_type':'linear','combine_embeds':'concat','start_at':0.0,'end_at':0.6,'embeds_scaling':'V only'}},
 ...
 '13':{'class_type':'VHS_VideoCombine','inputs':{'images':['12',0],'frame_rate':24,'loop_count':0,'filename_prefix':f'line_{SEG}','format':'video/h264-mp4','pingpong':False,'save_output':True}},
}
