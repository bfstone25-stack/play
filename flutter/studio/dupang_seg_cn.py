...
W={
 ...
 '7':{'class_type':'IPAdapterAdvanced','inputs':{'model':['2',0],'ipadapter':['4',0],'image':['6',0],'clip_vision':['5',0],'weight':0.75,'weight_type':'linear','combine_embeds':'concat','start_at':0.0,'end_at':0.8,'embeds_scaling':'V only'}},
 ...
 '18':{'class_type':'ACN_AdvancedControlNetApply','inputs':{'positive':['8',0],'negative':['9',0],'control_net':['16',0],'image':['17',0],'strength':0.7,'start_percent':0.0,'end_percent':0.8}},
