...
NEG="color, colorful, realistic, photo, 3d, grey shading, ugly, blurry, deformed, text, watermark, multiple characters"
BODY="a cute goofy capsule mascot, big goggle eyes, buck-tooth grin"
PT=('"0": "'+BODY+', shocked terrified, water pipe bursting spraying water, '+STYLE+'",\n'
    '"90": "'+BODY+', smug grin holding a glowing book, hopeful, '+STYLE+'",\n'
    '"180": "'+BODY+', smashed by huge hammer, body flattened, petrified stone cracking, '+STYLE+'",\n'
    '"270": "'+BODY+', reforming from stone dust, dizzy holding book, silly, '+STYLE+'"')
W={
 ...
 "17":{"class_type":"VHS_LoadImages","inputs":{"directory":"ep01_line_full","image_load_cap":FRAMES,"skip_first_images":0,"select_every_nth":1}},
 ...
 "18":{"class_type":"ACN_AdvancedControlNetApply_v2","inputs":{"positive":["8",0],"negative":["9",0],"control_net":["16",0],"image":["17",0],"strength":0.65,"start_percent":0.0,"end_percent":0.7}},
 ...
 "13":{"class_type":"VHS_VideoCombine","inputs":{"images":["12",0],"frame_rate":24,"loop_count":0,"filename_prefix":"cn_full","format":"video/h264-mp4","pingpong":False,"save_output":True}},
}
