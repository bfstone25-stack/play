...
W={
 ...
 '16':{'class_type':'ControlNetLoaderAdvanced','inputs':{'control_net_name':'control_v11f1p_sd15_depth.pth'}},
 '17':{'class_type':'VHS_LoadImages','inputs':{'directory':TRAJ,'image_load_cap':FRAMES,'skip_first_images':0,'select_every_nth':1}},
 '18':{'class_type':'ACN_AdvancedControlNetApply','inputs':{'positive':['8',0],'negative':['9',0],'control_net':['16',0],'image':['17',0],'strength':0.5,'start_percent':0.0,'end_percent':0.6}},
