...
// puts in window.ROOM704_AD_HTML (the Adsterra snippet); with none configured the slot
...
(function () {
  ...
  window.Room704Ads = {
    ...
    open: function (key, kind) {
      ...
      if (window.ROOM704_AD_HTML && !isBot()) {
        ...
        f.setAttribute("scrolling", "no"); f.srcdoc = '<body style="margin:0;background:#000">' + window.ROOM704_AD_HTML + "</body>"; slot.appendChild(f);
      } else {
