...
const SFX = (() => {
  ...
  return {
    ...
    flipper() {
      tone({ freq: 96, type: "square", dur: 0.07, vol: 0.24, glideTo: 64 });
      noise({ dur: 0.055, vol: 0.13, freq: 680, q: 1.8 });
    },
    flipperHit() {
      tone({ freq: 82, type: "sine", dur: 0.14, vol: 0.5, glideTo: 46 });
      tone({ freq: 760, type: "triangle", dur: 0.09, vol: 0.25, glideTo: 1280 });
      noise({ dur: 0.08, vol: 0.18, freq: 1200, q: 1.2 });
    },
