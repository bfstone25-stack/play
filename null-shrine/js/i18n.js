...
(function () {
  const DICT = {
    zh: {
      "mascot.intro": "把光送进不可能的路径。按住，然后放手。",
      "mascot.burst": "熔断。贪心也要看时机。",
      "ui.launch": "发射",
      "ui.launchHint": "蓄力 / 释放",
      "ui.today": "今日",
      "ui.pulse": "脉冲",
      ...
      "ui.nearMiss": "近失",
      "ui.share": "分享",
      "ui.personaEmpty": "我会记住你的选择，而不是只记录输赢。",
    ...
    en: {
      "mascot.intro": "Send the light down an impossible line. Hold, then let go.",
      "mascot.burst": "Burnout. Greed has a schedule too.",
      "ui.launch": "LAUNCH",
      "ui.launchHint": "Hold / release",
      "ui.today": "TODAY",
      "ui.pulse": "BALLS",
      "ui.core": "CORES",
      "ui.nearMiss": "NEAR",
      "ui.share": "Share",
      "ui.personaEmpty": "I remember the choices you make, not just the score.",
    ...
    ja: {
      "mascot.intro": "あり得ない軌道へ光を送れ。長押しして、離す。",
      "mascot.burst": "焼き切れた。欲にも時機がある。",
      "ui.launch": "発射",
      "ui.launchHint": "長押し / 離す",
      "ui.today": "本日",
      "ui.pulse": "玉数",
      "ui.core": "コア",
      "ui.nearMiss": "ニアミス",
      "ui.share": "共有",
      "ui.personaEmpty": "勝ち負けだけでなく、あなたの選択を覚えています。",
