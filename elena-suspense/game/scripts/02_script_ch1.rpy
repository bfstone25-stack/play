...
label start:
    ...
    narrator "Rain hammers the Gothic windows of the faculty archives."
    narrator "Leather, parchment, and wet cedar fill the air."

    protagonist "Vault alert. Blackwood wing. After-hours seal engaged."
    protagonist "Someone is still inside a room that should have locked five minutes ago."

    play sound page_flip

    narrator "You take the faculty override key from the desk drawer and head downstairs."
    narrator "The corridor lights flicker. Behind the iron vault door, a camera shutter clicks once, then again."
    ...
    narrator "Elena. Twenty-two. Your sharpest postgraduate assistant, and the last person who should be trapped in here."
    narrator "Her blazer is immaculate. Her breathing is not."

    elena "Professor Vance...? I... I can explain. The seal closed while I was still copying."

    protagonist "Copying a restricted ledger after curfew. In a vault that auto-locks."

    elena "I wasn't running. I needed the pages before dawn. If I left and came back tomorrow, the crate would be gone."

    narrator "Her fingers tighten around the leather folder. A gilded corner of the uncataloged ledger slips into view."
    ...
    elena "I didn't take it to sell it. My family's name was scrubbed from these records thirty years ago. I only wanted proof."

    protagonist "Proof of what, Elena?"

    elena "That we were never outsiders to this place. That someone erased us on purpose."

    narrator "Her voice drops. Pressed against the shelves, she is shaking, but she does not drop the ledger."
