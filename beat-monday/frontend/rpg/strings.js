/* UI copy. Never hardcode a user-visible string in the loop. en + zh-Hans ship
   together (PLAN.md locale rule); es/pt/ja fall back to en until translated. */
var BMStrings = {
  en: {
    brand: "BEAT MONDAY", sub: "A WORK WEEK RPG",
    ...
    sk_overtime: "Spite — +2 attack",
    sk_boundary: "A Boundary — +18 max HP",
    sk_caffeine: "Cold Brew — attack faster",
    sk_sneakers: "Sneakers — move faster",
    sk_delegate: "Delegate — attacks pierce",
    sk_mute: "Mute Thread — everything slows",
    sk_ccall: "CC Everyone — one more projectile",
    ...
    equipped: "WORN", tap_equip: "tap to equip / remove",
  },
  zh: {
    ...
    lvup: "等级 {n}", pick: "选一个",
    sk_overtime: "怨气 — 攻击 +2",
    sk_boundary: "边界感 — 血上限 +18",
    sk_caffeine: "冰美式 — 攻速提升",
    sk_sneakers: "球鞋 — 移速提升",
    sk_delegate: "甩锅 — 子弹穿透",
    sk_mute: "免打扰 — 全场变慢",
    sk_ccall: "全员抄送 — 多一发",
    ...
    equipped: "已装备", tap_equip: "点一下装备／卸下",
  },
};
if (typeof module !== "undefined") module.exports = BMStrings;
