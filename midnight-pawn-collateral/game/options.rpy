...
define config.save_directory = "midnight_pawn_collateral-1789700000"
...
init python:
    build.directory_name = "midnight-pawn-collateral-v1.0.0"
    build.executable_name = "MidnightPawnCollateral"
