...
func _init() -> void:
	...
	cam.current = true
	var shots := [
		{"name": "vanity_toilet", "pos": Vector3(7.2, 0.05, 10.55), "look": Vector3(8.55, 1.05, 11.05)},
		{"name": "basin_tap", "pos": Vector3(7.55, 0.05, 10.75), "look": Vector3(8.55, 1.05, 11.0)},
		{"name": "full_bath", "pos": Vector3(6.55, 0.05, 10.45), "look": Vector3(7.9, 1.15, 11.4)},
