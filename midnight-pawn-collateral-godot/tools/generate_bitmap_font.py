...
def source_charset() -> list[str]:
    ...
    # 2026-09-23 (LIEN zh/ja): the story tables are data files, not scripts; every glyph in
    # them must be in the atlas or the web build draws boxes with no error.
