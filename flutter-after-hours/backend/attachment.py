...
def detect(history, message=""):
    ...
    # Attachment is a longitudinal communication hypothesis, never a diagnosis.
    # One phrase or a pair of short messages is not enough evidence.
    if len(user_msgs) < 4 or total < 2.5:
