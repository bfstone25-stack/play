...
(OUT / "reader.json").write_text(json.dumps(pool_reader.READER, ensure_ascii=False, indent=0), "utf-8")
(OUT / "ui.json").write_text(json.dumps(pool_ui.UI, ensure_ascii=False, indent=0), "utf-8")
