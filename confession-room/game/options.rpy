...
define config.name = _("Confession Room")
define gui.show_name = True
define config.version = "0.1.0"
define gui.about = _("Elena: Crimson Archives\nA Dark Academia suspense romance visual novel.\nFlat 404 / Ren'Py 8.")

define build.name = "confession_room"

define config.has_sound = True
define config.has_music = True
define config.has_voice = False

## Was audio/suspense_theme.ogg, a file this game never had (it was Room 704's), so the
## menu sat in silence. The drone is the bed; the sting plays over it from screens.rpy.
define config.main_menu_music = "audio/noir_theme.ogg"
...
define config.save_directory = "confession_room-1789620000"
...
init python:
    build.directory_name = "confession-room-v0.1.0"
    build.executable_name = "ConfessionRoom"
